...
namespace BoletoNet
{
    ...
    internal class Banco_Sicoob : AbstractBanco, IBanco
    {
        ...
        public override void FormataNossoNumero(Boleto boleto)
        {
            ...
            String nossoNumero = boleto.NossoNumero.Contains("-") ? boleto.NossoNumero.Substring(0, boleto.NossoNumero.IndexOf("-")) : boleto.NossoNumero;
        ...
        private string GerarHeaderRemessaCNAB240(int numeroConvenio, Cedente cedente, int numeroArquivoRemessa)
        {
            ...
            try
            {
                ...
                header += DateTime.Now.ToString("HHmmss"); //Utils.FormatCode("", "0", 6);            //Posição 152 a 157       Hora de Geração do Arquivo
        ...
        private string GerarDetalheRemessaCNAB400(Boleto boleto, int numeroRegistro, TipoArquivo tipoArquivo)
        {
            ...
            try
            {
                ...
                _detalhe.Append(Utils.FitStringLength(boleto.Banco.Codigo.ToString(), 3, 3, '0', 0, true, true, true)); //Posição 140 a 142
        ...
        public override string GerarDetalheSegmentoRRemessa(Boleto boleto, int numeroRegistro, TipoArquivo tipoArquivo)
        {
            try
            {
                ...
                detalhe += Utils.FormatCode("", 8); //Posição 232 - 240 Uso Exclusivo FEBRABAN/CNAB: Brancos
                detalhe = Utils.SubstituiCaracteresEspeciais(detalhe);
                return detalhe;
            }
            catch (Exception e)
