...
namespace BoletoNet
{
	public class Banco : IBanco
	{
		...
		public void FormataCodigoBarra(Boleto boleto)
		{
			...
			{
				throw new Exception("Erro durante a formatação do codigo de barra.", ex);
			}
		}
		...
		public void FormataLinhaDigitavel(Boleto boleto)
		{
			...
			{
				throw new Exception("Erro durante a formatação da linha digitavel.", ex);
			}
		}
		...
		public void FormataNossoNumero(Boleto boleto)
		{
			...
			{
				throw new Exception("Erro durante a formatação do nosso numero.", ex);
			}
		}
		...
		public void FormataNumeroDocumento(Boleto boleto)
		{
			...
			{
				throw new Exception("Erro durante a formatação do numero do documento.", ex);
			}
		}
		...
		#region Metodos de Validacao de geracao de arquivo
		...
		#region Metodos de geracao de arquivo
		...
		public string GerarHeaderRemessa(string numeroConvenio, Cedente cedente, TipoArquivo tipoArquivo, int numeroArquivoRemessa)
		{
			...
			{
				throw new Exception("Erro durante a geracao do registro HEADER do arquivo de REMESSA.", ex);
			}
		}
		...
		public string GerarDetalheRemessa(Boleto boleto, int numeroRegistro, TipoArquivo tipoArquivo)
		{
			...
			{
				throw new Exception("Erro durante a geracao dos registros de DETALHE do arquivo de REMESSA.", ex);
			}
		}
		...
		public string GerarMensagemVariavelRemessa(Boleto boleto, ref int numeroRegistro, TipoArquivo tipoArquivo)
		{
			...
			{
				throw new Exception("Erro durante a geracao do registro MENSAGEM VARIAVEL do arquivo de REMESSA.", ex);
			}
		}
