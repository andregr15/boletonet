...
namespace BoletoNet
{
    ...
    internal class Banco_Banestes : AbstractBanco, IBanco
    {
        ...
        /// - Moeda 	                 01 Posição (9)
        /// - Digito Verificador 	     01 Posição (descrito abaixo)
        /// - Fator de Vencimento....... 04 posicoes  (descrito na página 19)
        ...
        public override void FormataNossoNumero(Boleto boleto)
        {
            try
            {
                ...
                if (boleto.NossoNumero.Length > 8)
                    throw new Exception("Tamanho máximo para o Nosso numero sao de 8 caracteres");
        ...
        /// (este campo é reservado para identificar a Agencia, cliente, numero do titulo, etc. no banco cedente do titulo).
        ...
        public string GerarDetalheRemessaCNAB400(Boleto boleto, int numeroRegistro, TipoArquivo tipoArquivo)
        {
            try
            {
                ...
                _detalhe = "1"; // Codigo do registro "Transação"
                ...
                _detalhe += vInstrucao1; // Primeira instrução de Cobranca
                _detalhe += vInstrucao2; // Segunda instrução de Cobranca
