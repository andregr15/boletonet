...
[assembly: WebResource("BoletoNet.Imagens.089.jpg", "image/jpg")]
namespace BoletoNet
{
    /// <summary>
    ...
    /// Data: 25/02/2014
    /// </summary>
    internal class Banco_Credisan : AbstractBanco, IBanco
    {
        #region CONSTRUTOR
        /**
         * <summary>Construtor</summary>
         */
        internal Banco_Credisan()
        {
            this.Nome = "Credisan";
            this.Codigo = 089;
            this.Digito = "0";
        ...
        private string GerarHeaderRemessaCNAB240(int numeroConvenio, Cedente cedente, int numeroArquivoRemessa)
        {
            ...
            {
                //Montagem do header
                string header = "089"; //Posição 001 a 003   Código do Sicoob na Compensação: "756"
