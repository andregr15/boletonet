...
namespace BoletoNet
{
    public interface IBanco
    {
        ...
        /// <summary>
        /// Formata o numero do documento, alguns bancos exige uma formatação. Tipo: 123-4
        /// </summary>
        void FormataNumeroDocumento(Boleto boleto);        
        /// <summary>
        /// Responsável pela validação de todos os dados referente ao banco, que serao usados no boleto
        /// </summary>
