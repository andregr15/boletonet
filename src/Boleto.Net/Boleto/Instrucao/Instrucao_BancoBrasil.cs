            ...
            try
            {
                ...
                switch ((EnumInstrucoes_BancoBrasil)idInstrucao)
                {
                    ...
                    case EnumInstrucoes_BancoBrasil.ProtestarAposNDiasCorridos:
                        ...
                        this.Descricao = "Protestar no " + nrDias + "o dia corrido após vencimento";
                        break;
                    case EnumInstrucoes_BancoBrasil.ProtestarAposNDiasUteis:
                        ...
                        this.Descricao = "Protestar no " + nrDias + "o dia útil após vencimento";/*jaferson (jefhtavares) em 02/12/2013 a pedido do setor de homologação do BB*/
                        break;
                    case EnumInstrucoes_BancoBrasil.NaoReceberAposNDias:
                        this.Codigo = (int)EnumInstrucoes_BancoBrasil.NaoReceberAposNDias;
                        this.Descricao = "nao receber após " + nrDias + " dias do vencimento";
                        break;
