...
namespace BoletoNet
{
    //Classes básicas para manipulação de registros para geracao/interpretaçao de EDI
    ...
    {
        /// <summary>
        /// Representa um campo alfanumérico, alinhado à esquerda e com brancos à esquerda. A propriedade ValorNatural é do tipo String
        /// </summary>
        ...
        /// <summary>
        /// Representa um campo numérico inteiro alinhado à esquerda com zeros à esquerda. A propriedade ValorNatural é do tipo Int ou derivados
        /// </summary>
        ...
        /// alinhado à esquerda com zeros à esquerda. A propriedade ValorNatural é do tipo Double
        /// </summary>
        ...
        /// <summary>
        /// Representa um campo de data no formato DD/MM/AAAA, porem colocando zeros no lugar de espaços no ValorFormatado. A propriedade
        /// ValorNatural é do tipo DateTime, e este deve ser nulo caso queira que a data seja zero.
        /// </summary>
        ediDataDDMMAAAAWithZeros,
        /// <summary>
        /// Representa um campo de data no formato AAAA/MM/DD, porem colocando zeros no lugar de espaços no ValorFormatado. A propriedade
        /// ValorNatural é do tipo DateTime, e este deve ser nulo caso queira que a data seja zero.
        /// </summary>
    ...
    public class TCampoRegistroEDI
    {
        ...
        /// nao se aplique ao tipo de dado, o valor da propriedade sera ignorado nas funções de formatação.
        /// </summary>
        ...
        /// <summary>
        /// Valor formatado do campo, pronto para ser utilizado no arquivo EDI. A formatação sera de acordo
        /// com a especificada na propriedade TipoCampo, com numéricos alinhados à esquerda e zeros à esquerda
        /// e campos alfanuméricos alinhados à esquerda e com brancos à esquerda.
        ...
        /// <summary>
        /// Caractere de Preenchimento do campo da posicao inicial até a posicao final
        /// </summary>
        ...
        public TCampoRegistroEDI(TTiposDadoEDI pTipoCampo, int pPosicaoInicial, int pTamanho, int pDecimais, object pValor, char pPreenchimento, string pSeparadorHora, string pSeparadorData)
        {
            ...
            this._PosicaoInicial = pPosicaoInicial - 1; //Compensa a indexaçao com base em zero
                ...
                case TTiposDadoEDI.ediNumericoSemSeparador_:
                    {
                        ...
                        {
                            string aux = "";
                            this._ValorFormatado = aux.Trim().PadLeft(this._TamanhoCampo, ' ');//Se o numero for NULL, preenche com espaços em branco
                        }
                        else
                        {
    ...
    public enum TTipoRegistroEDI
    {
        ...
        treTrailler,
        /// <summary>
        /// Indica um registro sem definições, utilizado para transmissao socket ou similar
        /// </summary>
        treLinhaUnica
    }
