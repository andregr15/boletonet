...
{
    [TestClass]
    public class BancoBrasil17051Teste
    {
        #region Carteira 17-051
        ...
        [TestMethod]
        public void BancoDoBrasil_Carteira_17051_NossoNumero_ComCodigoConvenio_4Posicoes()
        {
            var boletoBancario = GerarBoletoCarteira17051();
        ...
        [TestMethod]
        public void BancoDoBrasil_Carteira_17051_NossoNumero_ComCodigoConvenio_6Posicoes()
        {
            var boletoBancario = GerarBoletoCarteira17051();
        ...
        [TestMethod]
        public void BancoDoBrasil_Carteira_17051_NossoNumero_ComCodigoConvenio_7Posicoes()
        {
            var boletoBancario = GerarBoletoCarteira17051();
        ...
        [TestMethod]
        public void BancoDoBrasil_Carteira_17051_LinhaDigitavel()
        {
            var boletoBancario = GerarBoletoCarteira17051();
        ...
        [TestMethod]
        public void BancoDoBrasil_Carteira_17051_CodigoBarra()
        {
            var boletoBancario = GerarBoletoCarteira17051();
